...
def get_config():
    ...
    # 同步训练配置
    # Diffusion训练组大小
    train.inner_diffusion_groupsize = 4
    # Diffusion微批次大小
    train.mirco_diffusion_train_batch_size = 1
    # 优势裁剪模式
    train.adv_mode = "all"  # all, positive_only, negative_only, one_only, binary
    # Diffusion优势裁剪最大值
    train.diffusion_adv_clip_max = 5.0
