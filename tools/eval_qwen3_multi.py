...
from tools.metric.compute_qwen_score import main as compute_score
import pandas as pd
import os
import torch
...
for root_path in test_root_paths:
    ...
    out_path = os.path.join(root_path, "0521_Qwen3-VL-8B-Instruct_results.csv")
    ...
    compute_score(out_path, end_index=100)