...
class CausalInferencePipeline(torch.nn.Module):
    ...
    def _initialize_kv_cache(self, batch_size, dtype, device, kv_cache_size_override: int | None = None, return_cache: bool = False):
        """
    ...
    def _initialize_crossattn_cache(self, batch_size, dtype, device, return_cache: bool = False):
        """
